...
class BollingerFadeStrategy(BaseStrategy):
    ...
    def __init__(self):
        ...
        self.suitable_regimes = [MarketRegime.RANGE, MarketRegime.LOW_VOLUME] # Onde fades são mais prováveis
    ...
    async def calculate_indicators(self, market_context: Dict[str, Any]) -> None:
        ...
        pip_size_indic = self._get_pip_size(market_context)
    ...
    def _create_bollinger_fade_signal(self, signal_side: str, indicators_dict: Dict[str, Any], # Renomeado
        ...
        pip_size_create = self._get_pip_size(market_context)
