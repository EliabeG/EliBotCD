...
# Aliases para compatibilidade com imports diretos de utils.helpers
calculate_sharpe_ratio = calculate_sharpe_ratio_simple
calculate_max_drawdown = calculate_max_drawdown_from_equity