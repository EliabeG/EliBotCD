...
class TradingBot:
    ...
    async def initialize(self):
        ...
        try:
            ...
            # Sincronizar relógio
            if not await self.ntp_sync.sync_time_with_server_pool(): # Usando método correto
    ...
    async def start(self):
        ...
        try:
            ...
            tasks = [
                ...
                asyncio.create_task(self.ntp_sync.start_periodic_sync(CONFIG.NTP_SYNC_MINUTES * 60)),
